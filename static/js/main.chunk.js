...
/* harmony import */ var _components_UserControl__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/UserControl */ "./src/components/UserControl.jsx");
...
function App() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Header__WEBPACK_IMPORTED_MODULE_1__["default"], {
    __self: this,
    __source: {
...
function Footer() {
  ...
  }, "\xA9 2023 Travel With Reason, LLC"));
}
...
function UserControl() {
  ...
  }, "\uD83D\uDED2 Orders"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
    className: "userbutton",
    onClick: () => {
      history.push("/search");
    },
  ...
  }, "\uD83D\uDD0D Search")), user.current_user.name === '' ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
    className: "userbutton",
    onClick: () => {
...
/* harmony import */ var _features_UserSlice__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../features/UserSlice */ "./src/features/UserSlice.jsx");
/* harmony import */ var _features_SessionSlice__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../features/SessionSlice */ "./src/features/SessionSlice.jsx");
/* harmony import */ var _features_UserServices__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../features/UserServices */ "./src/features/UserServices.jsx");
/* harmony import */ var _features_ModalSlice__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../features/ModalSlice */ "./src/features/ModalSlice.jsx");
...
function LoginForm() {
  ...
  function handleLogin(e) {
    ...
    if (username.length > 0 && password.length > 0) {
      Object(_features_UserServices__WEBPACK_IMPORTED_MODULE_4__["sessionTokenService"])().then(token => {
        if (token.csrf_token) {
          dispatch(Object(_features_SessionSlice__WEBPACK_IMPORTED_MODULE_3__["newSession"])(token));
          Object(_features_UserServices__WEBPACK_IMPORTED_MODULE_4__["loginService"])(username, password, token.csrf_token).then(user => {
            if (user.current_user) {
              dispatch(Object(_features_UserSlice__WEBPACK_IMPORTED_MODULE_2__["login"])(user));
              dispatch(Object(_features_ModalSlice__WEBPACK_IMPORTED_MODULE_5__["closeModal"])());
            } else {
...
/*!***********************!*\
  !*** ./src/config.js ***!
  \***********************/
/*! exports provided: API, SESSION, LOGIN, LOGOUT, FRONT, NEWS, GUIDES, STORE, COMMUNITY, ABOUT, CONTACT, VENDORS, TERMS, PRIVACY, ORDERS, SEARCH, REGISTER */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const API = "https://www.travelwithreason.com";
const SESSION = `${API}/session/token`;
const LOGIN = `${API}/user/login`;
const LOGOUT = `${API}/user/logout`;
const FRONT = `${API}/frontpage`;
const NEWS = `${API}/news`;
const GUIDES = `${API}/guides`;
...
async function loginService(username, password, csrf_token) {
  ...
  try {
    const response = await fetch(_config__WEBPACK_IMPORTED_MODULE_0__["LOGIN"] + params, options);
...
async function logoutService(logout_token, csrf_token) {
  ...
  try {
    const response = await fetch(_config__WEBPACK_IMPORTED_MODULE_0__["LOGOUT"] + params, options);
    const data = await response.json();
    return data;
  } catch {
    return {
...
async function sessionTokenService() {
  try {
    const response = await fetch(_config__WEBPACK_IMPORTED_MODULE_0__["SESSION"]);
