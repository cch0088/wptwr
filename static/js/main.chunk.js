...
/* harmony import */ var _components_forum_ForumPost__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/forum/ForumPost */ "./src/components/forum/ForumPost.jsx");
...
function App() {
  ...
  const [postId, setPostId] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])();
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_apollo_client__WEBPACK_IMPORTED_MODULE_10__["ApolloProvider"], {
    ...
    path: _config__WEBPACK_IMPORTED_MODULE_2__["UI_FORUM_THREADS"],
    ...
    path: _config__WEBPACK_IMPORTED_MODULE_2__["UI_FORUM_POST"],
    element: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_forum_ForumPost__WEBPACK_IMPORTED_MODULE_13__["default"], {
      postId: postId,
      __self: this,
      __source: {
        fileName: _jsxFileName,
...
function ForumPost({
  ...
  const appendPost = content => {
    ...
    const comments = {
      edges: [...topic.comments.edges, newPost]
    };
    setTopic({
      ...topic,
      comments
...
function ForumTopicList({
  ...
  const handleNavigation = postId => {
    setPostId(postId);
    navigate(_config__WEBPACK_IMPORTED_MODULE_5__["UI_FORUM_POST"]);
  };
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "forum-list-container",
    __self: this,
  ...
  }, "By ", topic.author.node.name, " on ", Object(_lib_validation__WEBPACK_IMPORTED_MODULE_2__["getDateFromString"])(topic.date)))))), !error && !loading && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
    className: "forum-button",
    __self: this,
    __source: {
      fileName: _jsxFileName,
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UI_FORUM_POST", function() { return UI_FORUM_POST; });
...
const UI_FORUM_POST = Object(_lib_validation__WEBPACK_IMPORTED_MODULE_0__["getRoot"])(WP_ROOT) + "forum/threads/post";
...
/***/ "./src/features/ForumTopicSlice.jsx":
/*!******************************************!*\
  !*** ./src/features/ForumTopicSlice.jsx ***!
  \******************************************/
/*! exports provided: forumTopicSlice, pushForumTopicContent, purgeForumTopicContent, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "forumTopicSlice", function() { return forumTopicSlice; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "pushForumTopicContent", function() { return pushForumTopicContent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "purgeForumTopicContent", function() { return purgeForumTopicContent; });
/* harmony import */ var _reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @reduxjs/toolkit */ "./node_modules/@reduxjs/toolkit/dist/redux-toolkit.esm.js");

const initialStateValue = [];
const forumTopicSlice = Object(_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__["createSlice"])({
  name: 'forumTopic',
  initialState: {
    value: initialStateValue
  },
...
const {
  pushForumTopicContent,
  purgeForumTopicContent
} = forumTopicSlice.actions;
/* harmony default export */ __webpack_exports__["default"] = (forumTopicSlice.reducer);
...
/* harmony import */ var _features_ForumTopicSlice__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./features/ForumTopicSlice */ "./src/features/ForumTopicSlice.jsx");
/* harmony import */ var _features_CategorySlice__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./features/CategorySlice */ "./src/features/CategorySlice.jsx");
...
const store = Object(_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_4__["configureStore"])({
  reducer: {
    ...
    forumTopic: _features_ForumTopicSlice__WEBPACK_IMPORTED_MODULE_9__["default"],
    category: _features_CategorySlice__WEBPACK_IMPORTED_MODULE_10__["default"],
